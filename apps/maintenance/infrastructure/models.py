...
class InterventionModel(models.Model):
    ...
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    bien_id = models.UUIDField()  # référence au bien du module stock (pas de FK directe pour rester découplé)
...
class InterventionPieceModel(models.Model):
    intervention = models.ForeignKey(InterventionModel, on_delete=models.CASCADE)
