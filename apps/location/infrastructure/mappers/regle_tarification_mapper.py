"""
Mapper pour la conversion entre l'entité domaine RegleTarification et
le modèle Django RegleTarification.

Gère les champs `bien_id` et `categorie_id`.
"""
...
from location.infrastructure.models import RegleTarification as RegleTarificationModel  # alias
...
class RegleTarificationMapper:
    ...
    def to_domain(model: RegleTarificationModel) -> RegleTarification:
        ...
        Args:
            model (RegleTarificationModel): Instance du modèle ORM.
    ...
    def to_model(agence_id: UUID, regle: RegleTarification) -> RegleTarificationModel:
        ...
        Args:
            agence_id (UUID): Identifiant de l'agence propriétaire.
            regle (RegleTarification): Entité domaine.

        Returns:
            RegleTarificationModel: Instance ORM prête à être sauvegardée.
        """
